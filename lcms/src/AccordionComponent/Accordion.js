...
const AccordionOutput = document.querySelector('#app');

//	ReactDOM.render(<Accordion panels={ panels }/>, AccordionOutput);

export default (<Accordion panels={ panels }/>, AccordionOutput);